 ...
 * Apache-2.0 */
!(function (t, e) {
  typeof exports == "object" && typeof module != "undefined" ? e(exports, require("leaflet")) : typeof define == "function" && define.amd ? define(["exports", "leaflet"], e) : e(((t = typeof globalThis != "undefined" ? globalThis : t || self).L = t.L || {}, t.L.esri = {}), t.L)
})(this, function (t, e) {
  'use strict'
  let i = '3.0.10';
      var s = window.XMLHttpRequest && "withCredentials" in new window.XMLHttpRequest;
      var r = "" === document.documentElement.style.pointerEvents;
      var o = {
          cors: s,
          pointerEvents: r
      };
  ...
  let y = {
      ...
      var S = function t(e, i) {
          ...
          if ("number" == typeof e.x && "number" == typeof e.y && (s.type = "Point", s.coordinates = [e.x, e.y], "number" == typeof e.z && s.coordinates.push(e.z)), e.points && (s.type = "MultiPoint", s.coordinates = e.points.slice(0)), e.paths && (1 === e.paths.length ? (s.type = "LineString", s.coordinates = e.paths[0].slice(0)) : (s.type = "MultiLineString", s.coordinates = e.paths.slice(0))), e.rings && (s = function(t) {
              ...
              }(e.rings.slice(0))), "number" == typeof e.xmin && "number" == typeof e.ymin && "number" == typeof e.xmax && "number" == typeof e.ymax && (s.type = "Polygon", s.coordinates = [
                  [
                      [e.xmax, e.ymax],
                      [e.xmin, e.ymax],
                      [e.xmin, e.ymin],
              ...
              ]), (e.geometry || e.attributes) && (s.type = "Feature", s.geometry = e.geometry ? t(e.geometry) : null, s.properties = e.attributes ? x(e.attributes) : null, e.attributes)) try {
              s.id = function(t, e) {
      ...
      var I = function t(e, i) {
          ...
          switch (e.type) {
              case "Point":
                  o.x = e.coordinates[0], o.y = e.coordinates[1], e.coordinates[2] && (o.z = e.coordinates[2]), o.spatialReference = r;
                  break;
              case "MultiPoint":
                  o.points = e.coordinates.slice(0), e.coordinates[0][2] && (o.hasZ = !0), o.spatialReference = r;
                  break;
              case "LineString":
                  o.paths = [e.coordinates.slice(0)], e.coordinates[0][2] && (o.hasZ = !0), o.spatialReference = r;
                  break;
              case "MultiLineString":
                  o.paths = e.coordinates.slice(0), e.coordinates[0][0][2] && (o.hasZ = !0), o.spatialReference = r;
                  break;
              case "Polygon":
                  o.rings = A(e.coordinates.slice(0)), e.coordinates[0][0][2] && (o.hasZ = !0), o.spatialReference = r;
                  break;
              case "MultiPolygon":
                  o.rings = function(t) {
                      ...
                      return e
                  }(e.coordinates.slice(0)), e.coordinates[0][0][0][2] && (o.hasZ = !0), o.spatialReference = r;
                  break;
              case "Feature":
                  e.geometry && (o.geometry = t(e.geometry, i)), o.attributes = e.properties ? x(e.properties) : {}, e.id && (o.attributes[i] = e.id);
                  break;
      ...
      var T = '<a href="http://leafletjs.com" title="A JS library for interactive maps">Leaflet</a>';
  /* @preserve
  ...
  function R(t) {
    if (
      ...
      let i = e.latLng(t.ymin, t.xmin);
              var s = e.latLng(t.ymax, t.xmax);
  ...
  function k(t) {
    for (var e in t.attributes) if (e.match(O)) return e
  }
          ...
          ;(s.type = 'text/css'),
            ...
            t.on('resize', function (e) {
              t.attributionControl &&
                (t.attributionControl._container.style.maxWidth = B(e.target))
            }),
            (t.attributionControl._esriAttributionAddedOnce = !0)
        }
        t.attributionControl.setPrefix(
          T + ' | Powered by <a href="https://www.esri.com">Esri</a>',
        ),
          e.DomUtil.addClass(
  ...
  function Z(t) {
    ...
    return t instanceof e.LatLngBounds
      ? ((i.geometry = P(t)), (i.geometryType = 'esriGeometryEnvelope'), i)
      : (t.getLatLng && (t = t.getLatLng()),
        ...
        'Polygon' === t.type ||
        'MultiPolygon' === t.type
          ? ((i.geometry = C(t)), (i.geometryType = q(t.type)), i)
          : void f(
    ...
    o.cors &&
      p(
        ...
        e.Util.bind(function (t, s) {
          if (!t) {
            i._esriAttributions = []
            for (let r = 0; r < s.contributors.length; r++)
              for (
                var o = s.contributors[r], n = 0;
                n < o.coverageAreas.length;
                n++
              ) {
                let a = o.coverageAreas[n];
                          var l = e.latLng(a.bbox[0], a.bbox[1]);
                          var u = e.latLng(a.bbox[2], a.bbox[3]);
  ...
  let W = {
      ...
      responseToFeatureCollection: M,
      geojsonToArcGIS: C,
      arcgisToGeoJSON: w,
      boundsToExtent: P,
      extentToBounds: R,
      calcAttributionWidth: B,
      setEsriAttribution: E,
      _setGeometry: Z,
      _getAttributionData: N,
      _updateMapAttribution: j,
      _findIdAttributeFromFeature: k,
      _findIdAttributeFromResponse: F,
    };
      var J = e.Class.extend({
      options: {
        proxy: !1,
        useCors: s,
      },
      ...
      initialize: function (t) {
        if (
          (t.request && t.options
            ...
            : (e.Util.setOptions(this, t), (this.options.url = U(t.url))),
          (this.params = e.Util.extend({}, this.params || {})),
          this.setters)
        )
          for (let i in this.setters) {
  ...
  let V = J.extend({
    ...
    run: function (t, e) {
      return (
        ...
        (D(this.options.url) && void 0 === this.options.isModern)
          ? ((this.params.f = 'geojson'),
            this.request(function (i, s) {
              this._trapSQLerrors(i), t.call(e, i, s, s)
            }, this))
          : this.request(function (i, s) {
              this._trapSQLerrors(i), t.call(e, i, s && M(s), s)
            }, this)
      )
    },
    count: function (t, e) {
    ...
    bounds: function (t, e) {
      return (
        ...
        this.request(function (i, s) {
          s && s.extent && R(s.extent)
            ? t.call(e, i, R(s.extent), s)
            : ((i = {
  ...
  let Y = X.extend({
    ...
    at: function (t) {
      return (
        t.length === 2 && (t = e.latLng(t)), this._setGeometryParams(t), this
      )
    },
    ...
    run: function (t, e) {
      return this.request(function (i, s) {
        if (i) t.call(e, i, void 0, s)
          ...
          for (let o = 0; o < r.features.length; o++) {
  ...
  let tt = X.extend({
    ...
    _responseToGeoJSON: function (t) {
      let e = t.location;
              var i = t.catalogItems;
              var s = t.catalogItemVisibilities;
              var r = {
          pixel: {
            type: 'Feature',
            geometry: {
  ...
  let it = e.Evented.extend({
    ...
    initialize: function (t) {
      ;(t = t || {}),
        ...
        (this.options.url = U(this.options.url))
    },
    ...
    _runQueue: function () {
      for (let t = this._requestQueue.length - 1; t >= 0; t--) {
  ...
  let at = it.extend({
    ...
    updateFeatures: function (t, e, i) {
      ...
      return (
        (t = C(t, this.options.idAttribute)),
        (t = s.length > 1 ? t : [t]),
        this.post(
          'updateFeatures',
          {
  ...
  var ut = window.location.protocol !== "https:" ? "http:" : "https:";
      ...
      onRemove: function (t) {
        z(t), t.off('moveend', j), e.TileLayer.prototype.onRemove.call(this, t)
      },
      _initPane: function () {
  ...
  var ct = e.TileLayer.extend({
    ...
    initialize: function (t) {
      ;(t = G((t = e.Util.setOptions(this, t)))),
        (this.tileUrl =
          (t.proxy ? t.proxy + '?' : '') +
          t.url +
          'tile/{z}/{y}/{x}' +
          ...
          this.metadata(function (i, s) {
            if (!i && s.spatialReference) {
              ...
              if (
                ...
                this._lodMap = {}
                for (
                  var o = s.tileInfo.lods, n = ct.MercatorZoomLevels, a = 0;
                  a < o.length;
                  a++
                ) {
                  var l = o[a]
    ...
    onRemove: function (t) {
      z(t), e.TileLayer.prototype.onRemove.call(this, t)
    },
    metadata: function (t, e) {
  ...
  let pt = e.ImageOverlay.extend({
      ...
      var dt = e.Layer.extend({
          ...
          onRemove: function(t) {
              z(t), this._currentImage && this._map.removeLayer(this._currentImage), this._popup && (this._map.off("click", this._getPopupData, this), this._map.off("dblclick", this._resetPopupState, this)), this._map.off("moveend", this._update, this)
          },
            ...
            i ||
              setTimeout(
                ...
                300,
                  ...
                  var s = this.identify().at(t.latlng);
  ...
  let yt = e.Layer.extend({
    ...
    _removeAllCells: function () {
      for (let t in this._cells) this._removeCell(t)
    },
    ...
    _retainParent: function (t, i, s, r) {
      let o = Math.floor(t / 2);
              ...
              var a = s - 1;
              var l = new e.Point(+o, +n);
      l.z = +a
      let u = this._cellCoordsToKey(l);
              var h = this._cells[u];
      return h && h.active
        ? ((h.retain = !0), !0)
    ...
    _retainChildren: function (t, i, s, r) {
      for (let o = 2 * t; o < 2 * t + 2; o++)
        for (let n = 2 * i; n < 2 * i + 2; n++) {
          var a = new e.Point(o, n)
          a.z = s + 1
          let l = this._cellCoordsToKey(a);
                      var u = this._cells[l];
          u && u.active
            ? (u.retain = !0)
    ...
    _resetGrid: function () {
      let t = this._map;
              var e = t.options.crs;
              var i = this._cellSize = this.getCellSize();
              var s = this._cellZoom;
              var r = this._map.getPixelWorldBounds(this._cellZoom);
    ...
    _getCelldPixelBounds: function (t) {
      let i = this._map;
              var s = i._animatingZoom ? Math.max(i._animateToZoom, i.getZoom()) : i.getZoom();
              var r = i.getZoomScale(s, this._cellZoom);
              var o = i.project(t, this._cellZoom).floor();
              var n = i.getSize().divideBy(2 * r);
    ...
    _update: function (t) {
      ...
      if (i) {
        ...
        let r = this._getCelldPixelBounds(t);
                  var o = this._pxBoundsToCellRange(r);
                  var n = o.getCenter();
                  var a = [];
                  var l = this.options.keepBuffer;
                  var u = new e.Bounds(o.getBottomLeft().subtract([l, -l]), o.getTopRight().add([l, -l]));
          )
        if (
          !(
            isFinite(o.min.x) &&
        ...
        if (Math.abs(s - this._cellZoom) > 1) this._setView(t, s)
          ...
          if (
            ...
            for (
              ...
              let y = this._cellCoordsToKey(a[d]);
                              var g = this._keyToCellCoords(y);
              this._activeCells[g]
                ? this._reuseCell(a[d])
    ...
    _cellCoordsToBounds: function (t) {
      let i = this._cellCoordsToNwSe(t);
              var s = new e.LatLngBounds(i[0], i[1]);
    ...
    _keyToCellCoords: function (t) {
      var i = t.split(':');
              var s = new e.Point(+i[0], +i[1]);
      return (s.z = +i[2]), s
    },
    _removeCell: function (t) {
      var e = this._cells[t]
      if (e) {
        let i = this._keyToCellCoords(t);
                  var s = this._wrapCoords(i);
                  var r = this._cellCoordsToBounds(this._wrapCoords(i));
        ;(e.current = !1),
    ...
    _reuseCell: function (t) {
      ...
      let i = this._wrapCoords(t);
              var s = this._cellCoordsToBounds(this._wrapCoords(t));
    ...
    _createCell: function (t) {
      let i = this._cellCoordsToKey(t);
              var s = this._wrapCoords(t);
              var r = this._cellCoordsToBounds(this._wrapCoords(t));
  ...
  ;(gt.prototype.query = function (t) {
    var e = this.getIndex(t)
    return this.values[e]
  }),
    (gt.prototype.getIndex = function (t) {
    ...
    (gt.prototype.between = function (t, e) {
    ...
    (gt.prototype.insert = function (t) {
      return this.values.splice(this.getIndex(t.value), 0, t), this
    }),
    (gt.prototype.bulkAdd = function (t, e) {
      return (
  ...
  let _t = yt.extend({
      ...
      initialize: function (t) {
        ...
        this.options.timeField.start && this.options.timeField.end
          ? ((this._startTimeIndex = new gt()), (this._endTimeIndex = new gt()))
          : this.options.timeField && (this._timeIndex = new gt()),
          (this._cache = {}),
      ...
      onAdd: function (t) {
        return (
          ...
          yt.prototype.onAdd.call(this, t)
        )
      },
      onRemove: function (t) {
        return (
          ...
          yt.prototype.onRemove.call(this, t)
        )
      },
      getAttribution: function () {
        return this.options.attribution
      ...
      setWhere: function (t, i, s) {
        ...
        for (var h in ((this._cache = {}), this._cells)) {
          n++
          let c = this._keyToCellCoords(h);
                      var p = this._cellCoordsToBounds(c);
      ...
      setTimeRange: function (t, i, s, r) {
        let o = this.options.from;
                  var n = this.options.to;
                  var a = 0;
                  var l = null;
                  var u = e.Util.bind((function(e) {
            e && (l = e),
      ...
      _filterExistingFeatures: function (t, i, s, r) {
        var o =
            t && i ? this._getFeaturesInTimeRange(t, i) : this._currentSnapshot;
                  var n = this._getFeaturesInTimeRange(s, r);
        if (n.indexOf)
      ...
      _getFeaturesInTimeRange: function (t, e) {
        ...
        if (this.options.timeField.start && this.options.timeField.end) {
          let r = this._startTimeIndex.between(t, e);
                      var o = this._endTimeIndex.between(t, e);
          i = r.concat(o)
        } else {
          if (!this._timeIndex)
            return (
      ...
      _featureWithinTimeRange: function (t) {
        ...
        let e = +this.options.from.valueOf();
                  var i = +this.options.to.valueOf();
        if ('string' === typeof this.options.timeField) {
          var s = +t.properties[this.options.timeField]
          return s >= e && s <= i
        }
        if (this.options.timeField.start && this.options.timeField.end) {
          let r = +t.properties[this.options.timeField.start];
                      var o = +t.properties[this.options.timeField.end];
      ...
      _handleZoomChange: function () {
        if (this._visibleZoom())
          for (let t in this._cells) {
            let e = this._cells[t].coords;
                          var i = this._cacheKey(e);
            this._cache[i] && this.addLayers(this._cache[i])
          }
        else
          this.removeLayers(this._currentSnapshot), (this._currentSnapshot = [])
      },
      authenticate: function (t) {
        return this.service.authenticate(t), this
      },
      ...
      initialize: function (t) {
        t.apikey && (t.token = t.apikey),
          _t.prototype.initialize.call(this, t),
      ...
      onRemove: function (t) {
        ...
        return _t.prototype.onRemove.call(this, t)
      },
      ...
      _updateLayer: function (t, i) {
        let s = [];
                  var r = this.options.coordsToLatLng || e.GeoJSON.coordsToLatLng;
        switch (
      ...
      cellEnter: function (t, i) {
        this._visibleZoom() &&
          ...
          e.Util.requestAnimFrame(
            e.Util.bind(function () {
              let t = this._cacheKey(i);
                      var e = this._cellCoordsToKey(i);
                      var s = this._cache[t];
      ...
      resetFeatureStyle: function (t) {
        let i = this._layers[t];
                  var s = this._originalStyle || e.Path.prototype.options;
        return (
          i &&
  ...
  ;(t.BasemapLayer = ht),
    ...
    (t.service = function (t) {
      return (t = G(t)), new it(t)
    }),
    (t.task = function (t) {
      return (t = G(t)), new J(t)
    }),
