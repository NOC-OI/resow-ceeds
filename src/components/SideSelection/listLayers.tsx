...
export const listLayers = {
  'Seabed Habitats': {
    layerNames: {
      ...
      'Habitat Map 2': {
        url: 'http://127.0.0.1:8080/v1/tiles/mytiles.all@1.0.0/{z}/{x}/{y}.mvt',
        data_type: 'MBTiles',
        content: 'This layer represents...',
      },
      'Habitat Map 3': {
        url: 'http://127.0.0.1:8080/v1/tiles/mytiles.clipped_EUSeaMap_2021@1.0.0/{z}/{x}/{y}.mvt',
        data_type: 'MBTiles',
        content: 'This layer represents...',
      },
      Biozones: {
    ...
    layerNames: {
      'Chlorophyll-a': {
        ...
        params: {
          ...
          version: '1.3.0',
          layers:
            'All_European_Seas/Water_body_chlorophyll-a.nc*Water body chlorophyll-a_L2',
          format: 'image/png',
          style: 'pcolor_flat',
          transparent: true,
          info_format: 'text/html',
      ...
      'Dissolved Oxygen': {
        ...
        params: {
          ...
          version: '1.3.0',
          layers:
            'All_European_Seas/Water_body_dissolved_oxygen_concentration.nc*Water body dissolved oxygen concentration_L2',
          format: 'image/png',
          style: 'pcolor_flat',
          transparent: true,
          info_format: 'text/html',
      ...
      'Inorganic Nitrogen': {
        ...
        params: {
          ...
          version: '1.3.0',
          layers:
            'All_European_Seas/Water_body_dissolved_inorganic_nitrogen.nc*Water body dissolved inorganic nitrogen_L2',
          format: 'image/png',
          style: 'pcolor_flat',
          transparent: true,
          info_format: 'text/html',
      ...
      Phosphate: {
        ...
        params: {
          ...
          version: '1.3.0',
          layers:
            'All_European_Seas/Water_body_phosphate.nc*Water body phosphate_L2',
          format: 'image/png',
          style: 'pcolor_flat',
          transparent: true,
          info_format: 'text/html',
      ...
      Silicate: {
        ...
        params: {
          ...
          version: '1.3.0',
          layers:
            'All_European_Seas/Water_body_silicate.nc*Water body silicate_L2',
          format: 'image/png',
          style: 'pcolor_flat',
          transparent: true,
          info_format: 'text/html',
